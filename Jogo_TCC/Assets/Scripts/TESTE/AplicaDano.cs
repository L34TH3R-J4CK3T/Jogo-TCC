...
using UnityEngine.Events;
    ...
    public class AplicaDano : MonoBehaviour
    {
        [Serializable]
        public class DamagableEvent : UnityEvent<AplicaDano, Life>
        { }


        [Serializable]
        public class NonDamagableEvent : UnityEvent<AplicaDano>
        { }
        ...
        void FixedUpdate()
        {
            ...
            for (int i = 0; i < hitCount; i++)
            {
                ...
                Life damageable = m_LastHit.GetComponent<Life>();
