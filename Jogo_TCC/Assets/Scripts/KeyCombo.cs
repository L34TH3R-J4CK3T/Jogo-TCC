...
/** aprimoramento necessario, codigo so funciona em uma direçao
 * ou duplicar cada combo para direçao contraria (espelhado)
 * fazer que quando um array ser aceito deletar o array
 * usar queue talvez
**/
using UnityEngine;
